...
import pickle
import os
from emotion_recognition_using_speech_master.convert_wavs import convert_audio
...
def extract_feature(file_name, **kwargs):
    ...
    try:
        ...
        #有改动
        convert_audio(file_name, new_filename)
        # if v:
...
def get_best_estimators(classification):
    ...
    """
    if classification:
        return pickle.load(open("emotion_recognition_using_speech_master/grid/best_classifiers.pickle", "rb"))
    else:
        return pickle.load(open("emotion_recognition_using_speech_master/grid/best_regressors.pickle", "rb"))
