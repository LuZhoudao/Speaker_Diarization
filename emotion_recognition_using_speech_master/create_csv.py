...
def write_emodb_csv(emotions=["sad", "neutral", "happy"], train_name="train_emo.csv",
    ...
    for emotion, code in categories_reversed.items():
        if emotion not in emotions:
            del categories[code]
    for file in glob.glob(f"emotion_recognition_using_speech_master/data/emodb/wav/*.wav"):
        try:
...
def write_custom_csv(emotions=['sad', 'neutral', 'happy'], train_name="train_custom.csv", test_name="test_custom.csv",
    ...
    for category in emotions:
        # train data
        for i, file in enumerate(glob.glob(f"emotion_recognition_using_speech_master/data/train-custom/*_{category}.wav")):
        ...
        # test data
        for i, file in enumerate(glob.glob(f"emotion_recognition_using_speech_master/data/test-custom/*_{category}.wav")):
